...
export default function Shell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative min-h-dvh text-gray-900">
      ...
      <header className="sticky top-0 z-30 border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="mx-auto max-w-5xl px-4 py-3 flex flex-wrap items-center justify-between gap-3">
          ...
          <nav className="flex flex-wrap items-center justify-end gap-2 sm:gap-3 text-sm">
            ...
            <Link to="/about" className={linkCls(pathname === "/about")}>About</Link>
      ...
      <footer className="mx-auto max-w-5xl px-4 py-8 text-xs text-neutral-500 flex items-center justify-between">
        <span>© {new Date().getFullYear()} Kuiz</span>
