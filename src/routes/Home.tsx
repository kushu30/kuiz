    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <section className="min-h-screen flex items-center justify-center px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
            ...
            {!user ? (
              ...
              >
                <Button 
                  ...
                  className="px-8 py-4 text-lg bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black shadow-lg hover:shadow-xl transition-all duration-300 text-white"
                >
          ...
          >
            Join thousands of users crafting interactive quizzes with ease. 
